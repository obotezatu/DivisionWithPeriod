...
public class DivisionFormatterTest {
	...
	public void testDivisionFormatterFormat() {
		expected.append("_78945 | 4").append(lineSeparator()).append(" 4     |--------").append(lineSeparator())
				...
				.append(lineSeparator()).append("   12").append(lineSeparator()).append("   --").append(lineSeparator())
				.append("   _25").append(lineSeparator()).append("    24").append(lineSeparator()).append("    --")
				.append(lineSeparator()).append("    _10").append(lineSeparator()).append("      8")
				.append(lineSeparator()).append("     --").append(lineSeparator()).append("     _20")
				.append(lineSeparator()).append("      20").append(lineSeparator()).append("      --")
	...
	public void testRepeatedDecimalsWithoutPeriod() {
		expected.append("_1236 | 125").append(lineSeparator()).append(" 1125 |--------").append(lineSeparator())
				.append(" ---- | 9.888").append(lineSeparator()).append(" _1110").append(lineSeparator())
				.append("  1000").append(lineSeparator()).append("  ----").append(lineSeparator()).append("  _1100")
				.append(lineSeparator()).append("   1000").append(lineSeparator()).append("   ----")
				.append(lineSeparator()).append("   _1000").append(lineSeparator()).append("    1000")
				.append(lineSeparator()).append("    ----").append(lineSeparator()).append("        0");
