...
public class DivisionFormatterTest {
	...
	public void testDivisionFormatterFormat() {
		expected.append("_78945 | 4").append(lineSeparator())
				.append(" 4     |--------").append(lineSeparator())
				.append(" -     | 19736.25").append(lineSeparator())
				.append("_38").append(lineSeparator())
				.append(" 36").append(lineSeparator())
				.append(" --").append(lineSeparator())
				.append(" _29").append(lineSeparator())
				.append("  28").append(lineSeparator())
				.append("  --").append(lineSeparator())
				.append("  _14").append(lineSeparator())
				.append("   12").append(lineSeparator())
				.append("   --").append(lineSeparator())
				.append("   _25").append(lineSeparator())
				.append("    24").append(lineSeparator())
				.append("    --").append(lineSeparator())
				.append("    _10").append(lineSeparator())
				.append("      8").append(lineSeparator())
				.append("     --").append(lineSeparator())
	...
	public void testRepeatedDecimalsWithoutPeriod() {
		expected.append("_1236 | 125").append(lineSeparator())
				.append(" 1125 |--------").append(lineSeparator())
				.append(" ---- | 9.888").append(lineSeparator())
				.append(" _1110").append(lineSeparator())
				.append("  1000").append(lineSeparator())
				.append("  ----").append(lineSeparator())
				.append("  _1100").append(lineSeparator())
				.append("   1000").append(lineSeparator())
				.append("   ----").append(lineSeparator())
	...
	public void testRepeatedDecimalsWithPeriod() {
		expected.append("_7  | 12").append(lineSeparator()).append(" 60 |--------").append(lineSeparator())
				.append(" -- | 0.58(3)").append(lineSeparator())
				.append("_100").append(lineSeparator())
				.append("  96").append(lineSeparator())
				.append(" ---").append(lineSeparator())
